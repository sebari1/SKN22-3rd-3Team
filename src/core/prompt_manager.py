...
class PromptManager:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            cls._instance._yaml_path = os.path.join(cls._instance.project_root, "src/core/prompts.yaml")
